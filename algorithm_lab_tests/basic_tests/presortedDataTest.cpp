...
TEST_F(PreSortedDataTest, bitonicRunsBasicTest) {
    std::vector<size_t> indexes;
...
TEST_F(PreSortedDataTest, bitonicRunsComplexTest) {
    std::vector<size_t> indexes;
...
TEST_F(PreSortedDataTest, bitonicRunsCornerCasesTest) {
    std::vector<size_t> indexes;
