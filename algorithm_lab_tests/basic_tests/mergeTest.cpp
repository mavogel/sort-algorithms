...
TEST_F(MergeTest, mixedTest) {
    ...
    myMerge(*list, *tmp8, 0, 1, 1);
    myMerge(*list, *tmp8, 2, 3, 3);
    myMerge(*list, *tmp8, 4, 5, 5);
    myMerge(*list, *tmp8, 6, 7, 7);

    myMerge(*list, *tmp8, 0, 2, 3);
    myMerge(*list, *tmp8, 4, 6, 7);

    myMerge(*list, *tmp8, 0, 4, 7);
    verifySorted(*list);

    std::shared_ptr<std::array<int, 7>> list2(new std::array<int, 7>{{3,4, 7,2, 2,1, 3}});
    myMerge(*list2, *tmp7, 0, 1, 1);
    myMerge(*list2, *tmp7, 2, 3, 3);
    myMerge(*list2, *tmp7, 4, 5, 5);
    myMerge(*list2, *tmp7, 6, 6, 6);

    myMerge(*list2, *tmp7, 0, 2, 3);
    myMerge(*list2, *tmp7, 4, 6, 6);

    myMerge(*list2, *tmp7, 0, 4, 6);
    verifySorted(*list2);

    std::shared_ptr<std::array<int, 6>> list3(new std::array<int, 6>{{3,4, 7,2, 2,1}});
    myMerge(*list3, *tmp6, 0, 1, 1);
    myMerge(*list3, *tmp6, 2, 3, 3);
    myMerge(*list3, *tmp6, 4, 5, 5);

    myMerge(*list3, *tmp6, 0, 2, 3);
    myMerge(*list3, *tmp6, 4, 5, 5);

    myMerge(*list3, *tmp6, 0, 4, 5);
    verifySorted(*list3);

    std::shared_ptr<std::array<int, 5>> list4(new std::array<int, 5>{{3,4, 7,2, 2}});
    myMerge(*list4, *tmp5, 0, 1, 1);
    myMerge(*list4, *tmp5, 2, 3, 3);
    myMerge(*list4, *tmp5, 4, 4, 4);

    myMerge(*list4, *tmp5, 0, 2, 3);
    myMerge(*list4, *tmp5, 4, 4, 4);

    myMerge(*list4, *tmp5, 0, 4, 4);
    verifySorted(*list4);

    std::shared_ptr<std::array<int, 4>> list5(new std::array<int, 4>{{3,4, 7,2}});
    myMerge(*list5, *tmp4, 0, 1, 1);
    myMerge(*list5, *tmp4, 2, 3, 3);

    myMerge(*list5, *tmp4, 0, 2, 3);
    verifySorted(*list5);
}

TEST_F(MergeTest, notSortedExceptionTest) {
    std::shared_ptr<std::array<int, 8>> tmp8(new std::array<int, 8>());

    std::shared_ptr<std::array<int, 8>> list(new std::array<int, 8>{{3,-1, 7,2, 2,1, 3,8}});
    ASSERT_THROW(myMerge(*list, *tmp8, 0, 4, 7), NotSortedException);

    std::shared_ptr<std::array<int, 8>> list2(new std::array<int, 8>{{3,4, 7,2, 2,1, 3,-1}});
    ASSERT_THROW(myMerge(*list2, *tmp8, 0, 4, 7), NotSortedException);
}
...
TEST_F(MergeTest, mixedDoubleTest) {
    ...
    myMerge(*dList, *tmp5, 0, 1, 1);
    myMerge(*dList, *tmp5, 2, 3, 3);
    myMerge(*dList, *tmp5, 4, 4, 4);

    myMerge(*dList, *tmp5, 0, 2, 3);
    myMerge(*dList, *tmp5, 4, 4, 4);

    myMerge(*dList, *tmp5, 0, 4, 4);
    verifySorted(*dList);
}
...
TEST_F(MergeTest, mixedStringTest) {
    ...
    myMerge(*dList, *tmp10, 0, 1, 1);
    myMerge(*dList, *tmp10, 2, 3, 3);
    myMerge(*dList, *tmp10, 4, 4, 4);

    myMerge(*dList, *tmp10, 0, 2, 3);
    myMerge(*dList, *tmp10, 4, 4, 4);

    myMerge(*dList, *tmp10, 0, 4, 4);
    verifySorted(*dList);
}
