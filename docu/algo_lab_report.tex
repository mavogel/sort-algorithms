...
\begin{description}
	...
	\item[Pseudocode]: Merge-Function
		...
		\end{lstlisting}
	\item[Example] The {\color{blue}blue} number is the middle, the {\color{red}red} numbers will be selected. \\[.5cm]
...
\begin{description}
	...
	\item[Pseudocode]: Natural Mergesort
		...
		\end{lstlisting}
	\item[Example] The {\color{blue}blue} and {\color{red}red} coloured numbers represent the pre-sorted parts of the data and in the following step the blue part will be merged with its following red part. \\[.5cm]
...
\subsection{Quicksort with hybridisation}
\begin{description}
...
Otherwise the previously mentioned 3-way-partitioning Quicksort is performed. Additionally to make it hybrid the following steps are added:
		\begin{enumerate}
			...
			\item If the case occurs that before the next recursion of the Quicksort starts one half contains $10x$ the amount of the other half the next recursion step is performed by diving the remaining data in the middle. To adjust this change a \texttt{merge}-step is performed after the recursion returns.
		\end{enumerate}
	\item[Pseudocode]:
		\begin{lstlisting}
			TODO 
...
\subsection{Mergesort}
\begin{table}[htdp]
	\caption{\textbf{Bottom-up} Mergesort - Results in $nanoseconds$}
	\begin{tabular}{|c|c|c|c|c|} \hline
		...
		64KB & 8.000 & TODO & TODO & TODO \\ \hline
		128KB & 16.000 & TODO & TODO & TODO \\ \hline
		256KB & 32.000& TODO & TODO & TODO \\ \hline
		512KB & 64.000 & TODO & TODO & TODO \\ \hline
		1MB & 128.000 & TODO & TODO & TODO \\ \hline
		2MB & 256.000 & TODO & TODO & TODO \\ \hline
		4MB & 512.000 & TODO & TODO & TODO \\ \hline
		8MB & 1024.000 & TODO & TODO & TODO \\ \hline
		16MB & 2048.000 & TODO & TODO & TODO \\ \hline
		32MB & 4096.000 & TODO & TODO & TODO \\ \hline
		64MB & 8192.000 & TODO & TODO & TODO \\ \hline
...
\begin{table}[htdp]
	\caption{\textbf{Natural} Mergesort - Results in $nanoseconds$}
	\begin{tabular}{|c|c|c|c|c|} \hline
		Size of data & Loop rounds & \parbox[c]{3.5cm}{Descending \\ $O(n*log_2~n)$} & \parbox[c]{3.5cm}{Random \\$O(n*log_2~n)$} & \parbox[c]{3.5cm}{Ascending \\ $O(n*log_2~n)$} \\ \hline
		64KB & 8.000 & TODO & TODO & TODO \\ \hline
		128KB & 16.000 & TODO & TODO & TODO \\ \hline
...
\begin{table}[htdp]
	\caption{Quicksort with \textbf{three-way-partitionoing} - Results in $nanoseconds$}
	\begin{tabular}{|c|c|c|c|c|} \hline
		Size of data & Loop rounds & \parbox[c]{3.5cm}{Descending \\ $O(n*log_2~n)$} & \parbox[c]{3.5cm}{Random \\$O(n*log_2~n)$} & \parbox[c]{3.5cm}{Ascending \\ $O(n*log_2~n)$} \\ \hline
		64KB & 8.000 & TODO & TODO & TODO \\ \hline
		128KB & 16.000 & TODO & TODO & TODO \\ \hline
...
\begin{table}[htdp]
	\caption{Quicksort with \textbf{hybridisation} - Results in $nanoseconds$}
	\begin{tabular}{|c|c|c|c|c|} \hline
		Size of data & Loop rounds & \parbox[c]{3.5cm}{Descending \\ $O(n*log_2~n)$} & \parbox[c]{3.5cm}{Random \\$O(n*log_2~n)$} & \parbox[c]{3.5cm}{Ascending \\ $O(n*log_2~n)$} \\ \hline
		64KB & 8.000 & TODO & TODO & TODO \\ \hline
		128KB & 16.000 & TODO & TODO & TODO \\ \hline
