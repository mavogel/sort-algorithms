...
class ThreeWayPartitioningQuickSortTest : public testing::Test {
protected:
    virtual void SetUp() {
...
TEST_F(ThreeWayPartitioningQuickSortTest, basicTest) {
    ...
    sortVia3WayPartitioningQuicksort(*list9);
    verifySorted(*list9);
}


TEST_F(ThreeWayPartitioningQuickSortTest, DescendingPresortedTest) {
    std::shared_ptr<std::array<int, 2>> list(new std::array<int, 2>{{5,4}});
    sortVia3WayPartitioningQuicksort(*list);
    verifySorted(*list);
