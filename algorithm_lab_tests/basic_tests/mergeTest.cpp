...
TEST_F(MergeTest, smallTest) {
    ...
    myMerge(*list0, *tmp0, 0, 0, 0, false, false);
    verifySorted(*list0);

    std::shared_ptr<std::array<int, 1>> list(new std::array<int, 1>{{3}});
    myMerge(*list, *tmp1, 0, 0, 1, false, false);
    verifySorted(*list);

    std::shared_ptr<std::array<int, 2>> list1(new std::array<int, 2>{{3,4}});
    myMerge(*list1, *tmp2, 0, 1, 2, false, false);
    verifySorted(*list1);

    std::shared_ptr<std::array<int, 2>> list2(new std::array<int, 2>{{6,4}});
    myMerge(*list2, *tmp2, 0, 1, 2, false, false);
    verifySorted(*list2);

    std::shared_ptr<std::array<int, 3>> list3(new std::array<int, 3>{{6,4, 1}});
    myMerge(*list3, *tmp3, 0, 1, 2, false, false);
    myMerge(*list3, *tmp3, 2, 2, 3, false, false);
    myMerge(*list3, *tmp3, 0, 2, 3, false, false);
    verifySorted(*list3);

    std::shared_ptr<std::array<int, 3>> list4(new std::array<int, 3>{{6,4, 5}});
    myMerge(*list4, *tmp3, 0, 1, 2, false, false);
    myMerge(*list4, *tmp3, 2, 2, 3, false, false);
    myMerge(*list4, *tmp3, 0, 2, 3, false, false);
    verifySorted(*list4);
}
...
TEST_F(MergeTest, mixedTest) {
    ...
    myMerge(*list, *tmp8, 0, 1, 2, false, false);
    myMerge(*list, *tmp8, 2, 3, 4, false, false);
    myMerge(*list, *tmp8, 4, 5, 6, false, false);
    myMerge(*list, *tmp8, 6, 7, 8, false, false);

    myMerge(*list, *tmp8, 0, 2, 4, false, false);
    myMerge(*list, *tmp8, 4, 6, 8, false, false);

    myMerge(*list, *tmp8, 0, 4, 8, false, false);
    verifySorted(*list);

    std::shared_ptr<std::array<int, 7>> list2(new std::array<int, 7>{{3,4, 7,2, 2,1, 3}});
    myMerge(*list2, *tmp7, 0, 1, 2, false, false);
    myMerge(*list2, *tmp7, 2, 3, 4, false, false);
    myMerge(*list2, *tmp7, 4, 5, 6, false, false);
    myMerge(*list2, *tmp7, 6, 6, 7, false, false);

    myMerge(*list2, *tmp7, 0, 2, 4, false, false);
    myMerge(*list2, *tmp7, 4, 6, 7, false, false);

    myMerge(*list2, *tmp7, 0, 4, 7, false, false);
    verifySorted(*list2);

    std::shared_ptr<std::array<int, 6>> list3(new std::array<int, 6>{{3,4, 7,2, 2,1}});
    myMerge(*list3, *tmp6, 0, 1, 2, false, false);
    myMerge(*list3, *tmp6, 2, 3, 4, false, false);
    myMerge(*list3, *tmp6, 4, 5, 6, false, false);

    myMerge(*list3, *tmp6, 0, 2, 4, false, false);
    myMerge(*list3, *tmp6, 4, 5, 6, false, false);

    myMerge(*list3, *tmp6, 0, 4, 6, false, false);
    verifySorted(*list3);

    std::shared_ptr<std::array<int, 5>> list4(new std::array<int, 5>{{3,4, 7,2, 2}});
    myMerge(*list4, *tmp5, 0, 1, 2, false, false);
    myMerge(*list4, *tmp5, 2, 3, 4, false, false);
    myMerge(*list4, *tmp5, 4, 4, 5, false, false);

    myMerge(*list4, *tmp5, 0, 2, 4, false, false);
    myMerge(*list4, *tmp5, 4, 4, 5, false, false);

    myMerge(*list4, *tmp5, 0, 4, 5, false, false);
    verifySorted(*list4);

    std::shared_ptr<std::array<int, 4>> list5(new std::array<int, 4>{{3,4, 7,2}});
    myMerge(*list5, *tmp4, 0, 1, 2, false, false);
    myMerge(*list5, *tmp4, 2, 3, 4, false, false);

    myMerge(*list5, *tmp4, 0, 2, 4, false, false);
    verifySorted(*list5);
}
...
TEST_F(MergeTest, mixedTestForNaturalMergeSort) {
    ...
    myMerge(*list, *tmp7, 0, 4, 7, false, false);
    verifySorted(*list);

    std::shared_ptr<std::array<int, 12>> list2(new std::array<int, 12>{{-1,-1,1,2,2,2,3,/**/2,6,7, 5,7}});
    myMerge(*list2, *tmp12, 7, 10,12, false, false);
    myMerge(*list2, *tmp12, 0, 7, 12, false, false);
    verifySorted(*list2);

    std::shared_ptr<std::array<int, 12>> list3(new std::array<int, 12>{{-1,-1,2,2, 1,2,3,/**/2,6,7, 5,7}});
    myMerge(*list3, *tmp12, 0, 4, 7, false, false);
    myMerge(*list3, *tmp12, 7, 10,12, false, false);

    myMerge(*list3, *tmp12, 0, 7, 12, false, false);
    verifySorted(*list3);
}
...
TEST_F(MergeTest, forNaturalMergeSortBitonicCasesTest) {
    ...
    myMerge(*list, *tmp16, 0, 5, 7, true, false);
    myMerge(*list, *tmp16, 7, 12,16, true, true);
    ...
    myMerge(*list1, *tmp16, 0, 5, 7, true, false); //asc
    myMerge(*list1, *tmp16, 7, 12,14, true, true); // desc
    ...
    myMerge(*list2, *tmp16, 0, 5, 7, true, false); //asc
    myMerge(*list2, *tmp16, 7, 12,14, true, true); // desc
    myMerge(*list2, *tmp16, 14, 15, 16, true, false); // asc
    ...
    myMerge(*list3, *tmp16, 0 , 4, 5, true, false); // asc
    myMerge(*list3, *tmp16, 5 , 9,11, true, true); // desc
    myMerge(*list3, *tmp16, 11, 14, 16, true, false); // asc
...
TEST_F(MergeTest, mixedDoubleTest) {
    ...
    myMerge(*dList, *tmp5, 0, 1, 2, false, false);
    myMerge(*dList, *tmp5, 2, 3, 4, false, false);
    myMerge(*dList, *tmp5, 4, 4, 5, false, false);

    myMerge(*dList, *tmp5, 0, 2, 4, false, false);
    myMerge(*dList, *tmp5, 4, 4, 5, false, false);

    myMerge(*dList, *tmp5, 0, 4, 5, false, false);
    verifySorted(*dList);
}
...
TEST_F(MergeTest, mixedStringTest) {
    ...
    myMerge(*dList, *tmp10, 0, 1, 2, false, false);
    myMerge(*dList, *tmp10, 2, 3, 4, false, false);
    myMerge(*dList, *tmp10, 4, 4, 5, false, false);

    myMerge(*dList, *tmp10, 0, 2, 4, false, false);
    myMerge(*dList, *tmp10, 4, 4, 5, false, false);

    myMerge(*dList, *tmp10, 0, 4, 5, false, false);
    verifySorted(*dList);
}