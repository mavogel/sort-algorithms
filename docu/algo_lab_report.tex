...
It is implemented in the following steps:
	...
	\item[Pseudocode]:
		...
		\end{lstlisting}	
	\item[Example] The {\color{red}red} number will be swapped,  {\color{blue}blue} number are the one for the next recursion. The {\color{green}green} numbers are sorted \\[.5cm]
